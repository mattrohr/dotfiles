...
brew "xz"                                    # common dependency
brew "sqlite"                                # common dependency
...
cask "carbon-copy-cloner"                    # bootable computer clone backup
...
cask "alfred"                                # 'spotlight' alternative with faster index access
cask "xquartz"                               # open-source version of the X.Org X Window System
cask "keyboardcleantool"                     # disables all keyboard and Touchbar input
mas "Dark Reader for Safari", id: 1438243180 # browser extension dark mode
mas "Wipr", id: 1320666476                   # browser extension ad blocker

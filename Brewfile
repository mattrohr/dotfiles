...
brew "tesseract"                             # convert images of text to editable and searchable text
brew "youtube-dl"                            # download video content, including--but not exclusively--YouTube
brew "zsh-autosuggestions"                   # populate remaining shell command from history
brew "zsh-completions"                       # populate available shell commands
...
brew "python@3.9"                            # default language of choice
...
cask "imageoptim"                            # optimally compress images for the web
cask "autodesk-fusion360"                    # design mechanical components
cask "kicad"                                 # design electronic circuits
cask "dymo-label"                            # create physical labels
cask "fujitsu-scansnap-home"                 # scan documents
...
cask "carbon-copy-cloner"                    # create bootable computer clone
cask "mactex"                                # typeset LaTeX and TeX documents
cask "transmission"                          # download torrents
cask "bartender"                             # remove menu bar clutter
cask "aerial"                                # display a cinematic screensaver
cask "nightowl"                              # fix macOS bug preventing automatic, system-wide darkmode mode at sunset
...
cask "xquartz"                               # allow applications to create and manage windows
cask "keyboardcleantool"                     # disable all keyboard and Touchbar input
cask "raspberry-pi-imager"                   # fetch and flash OS distributions to μSD cards
cask "zoom"                                  # communicate with humans
cask "skype"                                 # communicate with more humans
...
mas "Notability", id: 736189492              # take notes with synchronous handwriting and audio

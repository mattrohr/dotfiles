...
cask "canon-eos-webcam-utility"              # Record with Canon camera for video conferencing
cask "imageoptim"                            # Optimally compress images for the web to speed up page loads
cask "optimus-player"                        # Play more video formats than QuickTime; nicer UI and color reproduction than VLC
